...
function obtenerPuntaje() {
  ...
  while (sabor < 1 || sabor > 5 || presentacion < 1 || presentacion > 5 || dificultad < 1 || dificultad > 5) {
    if (sabor < 1 || sabor > 5 || presentacion < 1 || presentacion > 5 || dificultad < 1 || dificultad > 5) {
      ...
      sabor = rts.questionInt("Ingrese la calificacion del 'sabor'");
      presentacion = rts.questionInt("Ingrese la calificacion de la 'presentacion'");
      dificultad = rts.questionInt("Ingrese la calificacion de la 'dificultad'");
    }
  }
